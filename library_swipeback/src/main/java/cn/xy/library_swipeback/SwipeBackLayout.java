package cn.xy.library_swipeback;
...
import cn.xy.library_swipeback.tools.SwipeUtil;
...
public class SwipeBackLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        innerScrollView = SwipeUtil.findAllScrollViews(this);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        switch (MotionEventCompat.getActionMasked(ev)) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (innerScrollView != null && SwipeUtil.contains(innerScrollView, downX, downY)) {
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        public int clampViewPositionHorizontal(View child, int left, int dx) {
            ...
            if (isSwipeEnabled()) {
                if (mDirectionMode == FROM_LEFT && !SwipeUtil.canViewScrollRight(innerScrollView, downX, downY, false)) {
                    leftOffset = Math.min(Math.max(left, getPaddingLeft()), width);
                } else if (mDirectionMode == FROM_RIGHT && !SwipeUtil.canViewScrollLeft(innerScrollView, downX, downY, false)) {
        ...
        public int clampViewPositionVertical(View child, int top, int dy) {
            ...
            if (isSwipeEnabled()) {
                if (mDirectionMode == FROM_TOP && !SwipeUtil.canViewScrollUp(innerScrollView, downX, downY, false)) {
                    topOffset = Math.min(Math.max(top, getPaddingTop()), height);
                } else if (mDirectionMode == FROM_BOTTOM && !SwipeUtil.canViewScrollDown(innerScrollView, downX, downY, false)) {
